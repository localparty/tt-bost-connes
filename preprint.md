...
$$
\widetilde{\omega}_1 \thickspace =\thickspace  \bigotimes_{\mathfrak{p}}\thinspace  {\widetilde{\omega}}_1^{(\mathfrak{p})},
$$
...
$$
\sigma_t^{\omega_1}\bigl(\pi(a)\bigr) \thickspace =\thickspace  \pi\bigl(\alpha_t(a)\bigr) \qquad \text{for all } a \in B_K,\ t \in \mathbb{R}.
$$
...
$$
B_K \thickspace :=\thickspace  C^*\negthinspace \bigl(\thinspace \mathfrak{o}_K \rtimes \mathfrak{o}_K^\sharp\thinspace ,\thinspace  \mathfrak{o}_K \rtimes \mathfrak{o}_K^\times\thinspace \bigr)_{\mathrm{Hecke}}
$$
...
$$
\alpha_t\bigl(u(\xi)\bigr) \thickspace =\thickspace  u(\xi), \qquad \alpha_t(\mu_\mathfrak{a}) \thickspace =\thickspace  (N\mathfrak{a})^{it}\thinspace  \mu_\mathfrak{a}.
$$
...
$$
F_{a,b}(t) \thickspace =\thickspace  \omega\bigl(a\thinspace  \alpha_t(b)\bigr), \qquad F_{a,b}(t + i\beta) \thickspace =\thickspace  \omega\bigl(\alpha_t(b)\thinspace  a\bigr).
$$
...
$$
\omega_1\bigl(u(\xi)\thinspace \mu_\mathfrak{a}^* \mu_\mathfrak{b}\bigr) \thickspace =\thickspace 
\begin{cases}
(N\mathfrak{a})^{-1}\thinspace \omega_1\bigl(u(\xi)\bigr), & \mathfrak{a} = \mathfrak{b}, \\
0, & \mathfrak{a} \neq \mathfrak{b},
\end{cases}
\qquad
\omega_1\bigl(u(\xi)\bigr) \thickspace =\thickspace  \frac{\mu_K(\mathfrak{q})}{\varphi_K(\mathfrak{q})},
$$
...
$$
\rho_\mathfrak{p}(n) \thickspace =\thickspace  (1 - (N\mathfrak{p})^{-1})\thinspace  (N\mathfrak{p})^{-n}, \qquad n \geq 0.
$$
...
$$
I_\omega \thickspace :=\thickspace  \lbrace\thinspace  a \in A : \omega(a^* a) = 0 \thinspace \rbrace.
$$
...
$$
\omega_1\bigl((ba)^*(ba)\bigr) \thickspace =\thickspace  \omega_1\bigl(a^*\thinspace b^* b\thinspace  a\bigr) \thickspace \leq\thickspace  \|b\|^2\thinspace \omega_1\bigl(a^* a\bigr).
$$
...
$$
\bigl\langle [a],\thinspace  [b] \bigr\rangle \thickspace :=\thickspace  \omega_1(a^* b)
$$
...
$$
H_R \thickspace :=\thickspace  \overline{B_K / I_{\omega_1}}^{\thinspace \|\cdot\|}
$$
...
$$
\omega_1(a) \thickspace =\thickspace  \bigl\langle \Omega_1,\thinspace  \pi_{\omega_1}(a)\thinspace  \Omega_1 \bigr\rangle \qquad (a \in B_K).
$$
...
$$
M \thickspace \cong\thickspace  \bigotimes_\mathfrak{p}\thinspace  M_\mathfrak{p}
$$
...
$$
S\bigl(\pi(a)\thinspace \Omega_1\bigr) \thickspace :=\thickspace  \pi(a^*)\thinspace \Omega_1 \qquad (a \in B_K).
$$
...
$$
S\bigl(\lambda\thinspace \pi(a)\Omega_1 + \pi(b)\Omega_1\bigr) \thickspace =\thickspace  S\bigl(\pi(\lambda a + b)\thinspace \Omega_1\bigr) \thickspace =\thickspace  \pi((\lambda a + b)^*)\thinspace \Omega_1 \thickspace =\thickspace  \bar\lambda\thinspace \pi(a^*)\Omega_1 + \pi(b^*)\Omega_1.
$$
...
$$
F\bigl(\pi'(a')\thinspace \Omega_1\bigr) \thickspace :=\thickspace  \pi'(a'^*)\thinspace \Omega_1
$$
...
$$
\bigl\langle S\thinspace \xi,\thinspace  \eta \bigr\rangle \thickspace =\thickspace  \bigl\langle F\thinspace \eta,\thinspace  \xi \bigr\rangle \qquad (\xi \in D_0,\ \eta \in D_0')
$$
...
$$
S \thickspace =\thickspace  J\thinspace \Delta^{1/2}
$$
...
$$
J^2 \thickspace =\thickspace  I, \qquad J^* \thickspace =\thickspace  J, \qquad J\thinspace \Delta\thinspace J \thickspace =\thickspace  \Delta^{-1}.
$$
...
$$
\bigl\langle \Delta\thinspace \xi,\thinspace  \eta \bigr\rangle \thickspace =\thickspace  \bigl\langle S^* S\thinspace \xi,\thinspace  \eta \bigr\rangle \thickspace =\thickspace  \bigl\langle S\thinspace \eta,\thinspace  S\thinspace \xi \bigr\rangle \thickspace =\thickspace  \overline{\bigl\langle S\thinspace \xi,\thinspace  S\thinspace \eta \bigr\rangle} \thickspace =\thickspace  \bigl\langle \xi,\thinspace  \Delta\thinspace \eta \bigr\rangle,
$$
...
$$
J \thickspace :=\thickspace  S \circ |S|^{-1}
$$
...
$$
\xi \thickspace =\thickspace  S^2\thinspace \xi \thickspace =\thickspace  J\thinspace \Delta^{1/2}\thinspace J\thinspace \Delta^{1/2}\thinspace \xi \qquad (\xi \in D_0),
$$
...
$$
S \thickspace =\thickspace  \bigotimes_\mathfrak{p}\thinspace  S_\mathfrak{p}, \qquad \Delta \thickspace =\thickspace  \bigotimes_\mathfrak{p}\thinspace  \Delta_\mathfrak{p}, \qquad J \thickspace =\thickspace  \bigotimes_\mathfrak{p}\thinspace  J_\mathfrak{p},
$$
...
$$
\mathrm{spec}(\Delta) \thickspace =\thickspace  \overline{\bigl\lbrace\thinspace  \prod_{\mathfrak{p} \in F}\thinspace  (N\mathfrak{p})^{k_\mathfrak{p}} \thickspace :\thickspace  F \text{ finite},\ k_\mathfrak{p} \in \mathbb{Z}\thinspace \bigr\rbrace} \thickspace =\thickspace  [0, \infty),
$$
...
$$
\sigma_t^{\omega_1}(x) \thickspace :=\thickspace  \Delta^{it}\thinspace  x\thinspace  \Delta^{-it} \qquad (x \in M,\ t \in \mathbb{R}),
$$
...
$$
\sigma_t^{\omega_1}\bigl(\pi(a)\bigr) \thickspace =\thickspace  \pi\bigl(\alpha_t(a)\bigr).
$$
...
$$
\sigma_t^{\omega_1} \thickspace =\thickspace  \widetilde{\alpha}_t \qquad (t \in \mathbb{R})
$$
...
$$
\widehat{\tau}\bigl(u(\xi)\bigr) \thickspace :=\thickspace  u\bigl(\tau(\xi)\bigr), \qquad \widehat{\tau}(\mu_\mathfrak{a}) \thickspace :=\thickspace  \mu_{\tau(\mathfrak{a})}, \qquad (\xi \in K/\mathfrak{o}_K,\ \mathfrak{a} \in I_K^+).
$$
...
$$
\widehat{g}\bigl(\alpha_t(a)\bigr) \thickspace =\thickspace  \alpha_t\bigl(\widehat{g}(a)\bigr).
$$
...
$$
\widehat{g}(\alpha_t(\mu_\mathfrak{a})) \thickspace =\thickspace  \widehat{g}\bigl((N\mathfrak{a})^{it}\thinspace \mu_\mathfrak{a}\bigr) \thickspace =\thickspace  (N\mathfrak{a})^{it}\thinspace \mu_{g(\mathfrak{a})} \thickspace =\thickspace  (N(g(\mathfrak{a})))^{it}\thinspace \mu_{g(\mathfrak{a})} \thickspace =\thickspace  \alpha_t(\mu_{g(\mathfrak{a})}) \thickspace =\thickspace  \alpha_t(\widehat{g}(\mu_\mathfrak{a})),
$$
...
$$
U_g\thinspace \pi(\alpha_t(a))\thinspace U_g^* \thickspace =\thickspace  \pi(\alpha_t(\widehat{g}(a))) \qquad (a \in B_K,\ t \in \mathbb{R}).
$$

*(ii) The lifted Galois action intertwines with the modular conjugation:*

$$
U_g\thinspace J\thinspace U_g^* \thickspace =\thickspace  J.
$$
...
$$
U_g\thinspace S\thinspace U_g^*\thinspace \pi(a)\Omega_1 \thickspace =\thickspace  U_g\thinspace S\thinspace \pi(\widehat{g}^{-1}(a))\Omega_1 \thickspace =\thickspace  U_g\thinspace \pi(\widehat{g}^{-1}(a)^*)\Omega_1 \thickspace =\thickspace  \pi\bigl(\widehat{g}(\widehat{g}^{-1}(a)^*)\bigr)\Omega_1 \thickspace =\thickspace  \pi(a^*)\Omega_1 \thickspace =\thickspace  S\thinspace \pi(a)\Omega_1,
$$
...
$$
U_g\thinspace J\thinspace U_g^* \thickspace =\thickspace  J, \qquad U_g\thinspace \Delta\thinspace U_g^* \thickspace =\thickspace  \Delta. \qquad \square
$$
...
$$
D_\infty \thickspace :=\thickspace  \log \Delta
$$
...
$$
\Delta^{it} \thickspace =\thickspace  e^{itD_\infty} \qquad (t \in \mathbb{R})
$$
...
$$
\mathrm{spec}(D_\infty) \thickspace =\thickspace  \log\bigl(\mathrm{spec}(\Delta) \setminus \lbrace 0 \rbrace\bigr) \thickspace =\thickspace  \mathbb{R}.
$$
...
$$
D_\infty \thickspace =\thickspace  \sum_{\mathfrak{p}}\thinspace  \log \Delta_\mathfrak{p}
$$
