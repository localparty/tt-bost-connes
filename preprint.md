...
$$
\widetilde{\omega}_1 \;=\; \bigotimes_{\mathfrak{p}}\, {\widetilde{\omega}}_1^{(\mathfrak{p})},
$$
...
$$
\sigma_t^{\omega_1}\bigl(\pi(a)\bigr) \;=\; \pi\bigl(\alpha_t(a)\bigr) \qquad \text{for all } a \in B_K,\ t \in \mathbb{R}.
$$
...
$$
B_K \;:=\; C^*\!\bigl(\,\mathfrak{o}_K \rtimes \mathfrak{o}_K^\sharp\,,\, \mathfrak{o}_K \rtimes \mathfrak{o}_K^\times\,\bigr)_{\mathrm{Hecke}}
$$
...
$$
\alpha_t\bigl(u(\xi)\bigr) \;=\; u(\xi), \qquad \alpha_t(\mu_\mathfrak{a}) \;=\; (N\mathfrak{a})^{it}\, \mu_\mathfrak{a}.
$$
...
$$
F_{a,b}(t) \;=\; \omega\bigl(a\, \alpha_t(b)\bigr), \qquad F_{a,b}(t + i\beta) \;=\; \omega\bigl(\alpha_t(b)\, a\bigr).
$$
...
$$
\omega_1\bigl(u(\xi)\,\mu_\mathfrak{a}^* \mu_\mathfrak{b}\bigr) \;=\;
\begin{cases}
(N\mathfrak{a})^{-1}\,\omega_1\bigl(u(\xi)\bigr), & \mathfrak{a} = \mathfrak{b}, \\
0, & \mathfrak{a} \neq \mathfrak{b},
\end{cases}
\qquad
\omega_1\bigl(u(\xi)\bigr) \;=\; \frac{\mu_K(\mathfrak{q})}{\varphi_K(\mathfrak{q})},
$$
...
$$
\rho_\mathfrak{p}(n) \;=\; (1 - (N\mathfrak{p})^{-1})\, (N\mathfrak{p})^{-n}, \qquad n \geq 0.
$$
...
$$
\omega_1\bigl((ba)^*(ba)\bigr) \;=\; \omega_1\bigl(a^*\,b^* b\, a\bigr) \;\leq\; \|b\|^2\,\omega_1\bigl(a^* a\bigr).
$$
...
$$
\bigl\langle [a],\, [b] \bigr\rangle \;:=\; \omega_1(a^* b)
$$
...
$$
H_R \;:=\; \overline{B_K / I_{\omega_1}}^{\,\|\cdot\|}
$$
...
$$
\omega_1(a) \;=\; \bigl\langle \Omega_1,\, \pi_{\omega_1}(a)\, \Omega_1 \bigr\rangle \qquad (a \in B_K).
$$
...
$$
M \;\cong\; \bigotimes_\mathfrak{p}\, M_\mathfrak{p}
$$
...
$$
S\bigl(\pi(a)\,\Omega_1\bigr) \;:=\; \pi(a^*)\,\Omega_1 \qquad (a \in B_K).
$$
...
$$
S\bigl(\lambda\,\pi(a)\Omega_1 + \pi(b)\Omega_1\bigr) \;=\; S\bigl(\pi(\lambda a + b)\,\Omega_1\bigr) \;=\; \pi((\lambda a + b)^*)\,\Omega_1 \;=\; \bar\lambda\,\pi(a^*)\Omega_1 + \pi(b^*)\Omega_1.
$$
...
$$
F\bigl(\pi'(a')\,\Omega_1\bigr) \;:=\; \pi'(a'^*)\,\Omega_1
$$
...
$$
\bigl\langle S\,\xi,\, \eta \bigr\rangle \;=\; \bigl\langle F\,\eta,\, \xi \bigr\rangle \qquad (\xi \in D_0,\ \eta \in D_0')
$$
...
$$
J^2 \;=\; I, \qquad J^* \;=\; J, \qquad J\,\Delta\,J \;=\; \Delta^{-1}.
$$
...
$$
\bigl\langle \Delta\,\xi,\, \eta \bigr\rangle \;=\; \bigl\langle S^* S\,\xi,\, \eta \bigr\rangle \;=\; \bigl\langle S\,\eta,\, S\,\xi \bigr\rangle \;=\; \overline{\bigl\langle S\,\xi,\, S\,\eta \bigr\rangle} \;=\; \bigl\langle \xi,\, \Delta\,\eta \bigr\rangle,
$$
...
$$
\xi \;=\; S^2\,\xi \;=\; J\,\Delta^{1/2}\,J\,\Delta^{1/2}\,\xi \qquad (\xi \in D_0),
$$
...
$$
S \;=\; \bigotimes_\mathfrak{p}\, S_\mathfrak{p}, \qquad \Delta \;=\; \bigotimes_\mathfrak{p}\, \Delta_\mathfrak{p}, \qquad J \;=\; \bigotimes_\mathfrak{p}\, J_\mathfrak{p},
$$
...
$$
\sigma_t^{\omega_1}(x) \;:=\; \Delta^{it}\, x\, \Delta^{-it} \qquad (x \in M,\ t \in \mathbb{R}),
$$
...
$$
\sigma_t^{\omega_1}\bigl(\pi(a)\bigr) \;=\; \pi\bigl(\alpha_t(a)\bigr).
$$
...
$$
\sigma_t^{\omega_1} \;=\; \widetilde{\alpha}_t \qquad (t \in \mathbb{R})
$$
...
$$
\widehat{\tau}\bigl(u(\xi)\bigr) \;:=\; u\bigl(\tau(\xi)\bigr), \qquad \widehat{\tau}(\mu_\mathfrak{a}) \;:=\; \mu_{\tau(\mathfrak{a})}, \qquad (\xi \in K/\mathfrak{o}_K,\ \mathfrak{a} \in I_K^+).
$$
...
$$
\widehat{g}\bigl(\alpha_t(a)\bigr) \;=\; \alpha_t\bigl(\widehat{g}(a)\bigr).
$$
...
$$
\widehat{g}(\alpha_t(\mu_\mathfrak{a})) \;=\; \widehat{g}\bigl((N\mathfrak{a})^{it}\,\mu_\mathfrak{a}\bigr) \;=\; (N\mathfrak{a})^{it}\,\mu_{g(\mathfrak{a})} \;=\; (N(g(\mathfrak{a})))^{it}\,\mu_{g(\mathfrak{a})} \;=\; \alpha_t(\mu_{g(\mathfrak{a})}) \;=\; \alpha_t(\widehat{g}(\mu_\mathfrak{a})),
$$
...
$$
U_g\,\pi(\alpha_t(a))\,U_g^* \;=\; \pi(\alpha_t(\widehat{g}(a))) \qquad (a \in B_K,\ t \in \mathbb{R}).
$$
...
$$
U_g\,S\,U_g^*\,\pi(a)\Omega_1 \;=\; U_g\,S\,\pi(\widehat{g}^{-1}(a))\Omega_1 \;=\; U_g\,\pi(\widehat{g}^{-1}(a)^*)\Omega_1 \;=\; \pi\bigl(\widehat{g}(\widehat{g}^{-1}(a)^*)\bigr)\Omega_1 \;=\; \pi(a^*)\Omega_1 \;=\; S\,\pi(a)\Omega_1,
$$
...
$$
U_g\,J\,U_g^* \;=\; J, \qquad U_g\,\Delta\,U_g^* \;=\; \Delta. \qquad \square
$$
...
$$
\Delta^{it} \;=\; e^{itD_\infty} \qquad (t \in \mathbb{R})
$$
...
$$
D_\infty \;=\; \sum_{\mathfrak{p}}\, \log \Delta_\mathfrak{p}
$$
