...
$$
B_K \mspace{5mu} :=\mspace{5mu}  C^*\mspace{-3mu} \bigl(\mspace{3mu} \mathfrak{o}_K \rtimes \mathfrak{o}_K^\sharp\mspace{3mu} ,\mspace{3mu}  \mathfrak{o}_K \rtimes \mathfrak{o}_K^\times\mspace{3mu} \bigr)_{\mathrm{Hecke}}
$$
...
$$
\omega_1\bigl(u(\xi)\mspace{3mu} \mu_\mathfrak{a}^* \mu_\mathfrak{b}\bigr) \mspace{5mu} =\mspace{5mu} 
\begin{cases}
...
$$
I_\omega \mspace{5mu} :=\mspace{5mu}  \lbrace\mspace{3mu}  a \in A : \omega(a^* a) = 0 \mspace{3mu} \rbrace.
$$
...
$$
\omega_1\bigl((ba)^*(ba)\bigr) \mspace{5mu} =\mspace{5mu}  \omega_1\bigl(a^*\mspace{3mu} b^* b\mspace{3mu}  a\bigr) \mspace{5mu} \leq\mspace{5mu}  \|b\|^2\mspace{3mu} \omega_1\bigl(a^* a\bigr).
$$
...
$$
\bigl\langle [a],\mspace{3mu}  [b] \bigr\rangle \mspace{5mu} :=\mspace{5mu}  \omega_1(a^* b)
$$
...
$$
S\bigl(\pi(a)\mspace{3mu} \Omega_1\bigr) \mspace{5mu} :=\mspace{5mu}  \pi(a^*)\mspace{3mu} \Omega_1 \qquad (a \in B_K).
$$
...
$$
S\bigl(\lambda\mspace{3mu} \pi(a)\Omega_1 + \pi(b)\Omega_1\bigr) \mspace{5mu} =\mspace{5mu}  S\bigl(\pi(\lambda a + b)\mspace{3mu} \Omega_1\bigr) \mspace{5mu} =\mspace{5mu}  \pi((\lambda a + b)^*)\mspace{3mu} \Omega_1 \mspace{5mu} =\mspace{5mu}  \bar\lambda\mspace{3mu} \pi(a^*)\Omega_1 + \pi(b^*)\Omega_1.
$$
...
$$
F\bigl(\pi'(a')\mspace{3mu} \Omega_1\bigr) \mspace{5mu} :=\mspace{5mu}  \pi'(a'^*)\mspace{3mu} \Omega_1
$$
...
$$
J^2 \mspace{5mu} =\mspace{5mu}  I, \qquad J^* \mspace{5mu} =\mspace{5mu}  J, \qquad J\mspace{3mu} \Delta\mspace{3mu} J \mspace{5mu} =\mspace{5mu}  \Delta^{-1}.
$$
...
$$
\bigl\langle \Delta\mspace{3mu} \xi,\mspace{3mu}  \eta \bigr\rangle \mspace{5mu} =\mspace{5mu}  \bigl\langle S^* S\mspace{3mu} \xi,\mspace{3mu}  \eta \bigr\rangle \mspace{5mu} =\mspace{5mu}  \bigl\langle S\mspace{3mu} \eta,\mspace{3mu}  S\mspace{3mu} \xi \bigr\rangle \mspace{5mu} =\mspace{5mu}  \overline{\bigl\langle S\mspace{3mu} \xi,\mspace{3mu}  S\mspace{3mu} \eta \bigr\rangle} \mspace{5mu} =\mspace{5mu}  \bigl\langle \xi,\mspace{3mu}  \Delta\mspace{3mu} \eta \bigr\rangle,
$$
...
$$
U_g\mspace{3mu} \pi(\alpha_t(a))\mspace{3mu} U_g^* \mspace{5mu} =\mspace{5mu}  \pi(\alpha_t(\widehat{g}(a))) \qquad (a \in B_K,\ t \in \mathbb{R}).
$$

*(ii) The lifted Galois action intertwines with the modular conjugation:*

$$
U_g\mspace{3mu} J\mspace{3mu} U_g^* \mspace{5mu} =\mspace{5mu}  J.
$$
...
$$
U_g\mspace{3mu} S\mspace{3mu} U_g^*\mspace{3mu} \pi(a)\Omega_1 \mspace{5mu} =\mspace{5mu}  U_g\mspace{3mu} S\mspace{3mu} \pi(\widehat{g}^{-1}(a))\Omega_1 \mspace{5mu} =\mspace{5mu}  U_g\mspace{3mu} \pi(\widehat{g}^{-1}(a)^*)\Omega_1 \mspace{5mu} =\mspace{5mu}  \pi\bigl(\widehat{g}(\widehat{g}^{-1}(a)^*)\bigr)\Omega_1 \mspace{5mu} =\mspace{5mu}  \pi(a^*)\Omega_1 \mspace{5mu} =\mspace{5mu}  S\mspace{3mu} \pi(a)\Omega_1,
$$
...
$$
U_g\mspace{3mu} J\mspace{3mu} U_g^* \mspace{5mu} =\mspace{5mu}  J, \qquad U_g\mspace{3mu} \Delta\mspace{3mu} U_g^* \mspace{5mu} =\mspace{5mu}  \Delta. \qquad \square
$$
